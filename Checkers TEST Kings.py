...
def find_black_piece():
    ...
    if black_move_piece in line_A:
        ...
        counter = 0
        for e in line_A:
            if e == black_move_piece:
                line_A[counter] = black_king_removal
            counter += 1'''
...
def find_white_piece():
    ...
    if white_move_piece in line_H:
        ...
        counter = 0
        for e in line_H:
            if e == white_move_piece:
                line_H[counter] = white_king_removal
            counter += 1'''
    ...
    if current_player == 'black':
        ...
        if black_move_piece in black_king_pieces2:
            ...
            (MOVE_RIGHT, MOVE_LEFT, playable_black_piece_location, outside_line, line, eat_line, captured_row, EAT_LEFT,
             EAT_RIGHT, landing_location, eat_left_executed, eat_right_executed, king_new_location) = find_black_piece()

        '''king_selected = find_black_piece()'''
        ...
        if KING:
            ...
            if vertical_direction == 'u':
                (MOVE_RIGHT, MOVE_LEFT, EAT_RIGHT, EAT_LEFT, landing_location, eat_right_executed,
                 eat_left_executed, king_selected) = king_move_UP()
            elif vertical_direction == 'd':
                (MOVE_RIGHT, MOVE_LEFT, EAT_RIGHT, EAT_LEFT, landing_location, eat_right_executed,
                 eat_left_executed, king_selected) = king_move_DOWN()'''
        ...
        while not possible_move and not possible_eat:
            ...
            if black_move_piece in black_king_pieces2:
                ...
                (MOVE_RIGHT, MOVE_LEFT, playable_black_piece_location, outside_line, line, eat_line, captured_row,
                 EAT_LEFT, EAT_RIGHT, landing_location, eat_left_executed, eat_right_executed) = find_black_piece()
            '''if KING:
                vertical_direction = ask_vertical_direction()
                ...
                (MOVE_RIGHT, MOVE_LEFT, playable_black_piece_location, outside_line, line, eat_line,
                 captured_row, EAT_LEFT, EAT_RIGHT, landing_location, eat_right_executed, eat_left_executed, king_selected) = find_black_piece()'''
        ...
        if done_move == 'n' and eat_executed:
            ...
            (MOVE_RIGHT, MOVE_LEFT, playable_black_piece_location, outside_line, line, eat_line, captured_row,
             EAT_LEFT, EAT_RIGHT, landing_location, eat_right_executed, eat_left_executed, king_new_location) = find_black_piece()
            MOVE_LEFT = False
            MOVE_RIGHT = False
            # telling player if they chose a piece that cant be moved - TEMPORARY
            print('eat left: ', EAT_LEFT, 'eat right: ', EAT_RIGHT)
            ...
            if landing_location in line_A:
                ...
                king_new_location = black_move_piece
        ...
        if white_move_piece in white_king_pieces2:
            ...
            (MOVE_RIGHT, MOVE_LEFT, playable_black_piece_location, outside_line, line, eat_line, captured_row, EAT_LEFT,
             EAT_RIGHT, landing_location, eat_left_executed, eat_right_executed, king_new_location) = find_white_piece()

        ''''(MOVE_RIGHT, MOVE_LEFT, playable_white_piece_location, outside_line, line, eat_line, captured_row, EAT_LEFT,
         EAT_RIGHT, landing_location, eat_right_executed, eat_left_executed, king_selected) = find_white_piece()

        king_selected = find_white_piece()
        ...
        while not possible_move and not possible_eat:
            ...
            '''if KING:
                ...
                (MOVE_RIGHT, MOVE_LEFT, playable_black_piece_location, outside_line, line, eat_line,
                 captured_row, EAT_LEFT, EAT_RIGHT, landing_location, eat_right_executed, eat_left_executed, king_selected) = find_white_piece()'''
