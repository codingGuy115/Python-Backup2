...
def find_black_piece():
    ...
    print('move right: ', MOVE_RIGHT, 'move left: ', MOVE_LEFT)
...
# Pulling move_right and move_left out of the function to use later
    return(MOVE_RIGHT, MOVE_LEFT, playable_white_piece_location, outside_line, line, eat_line, captured_row, EAT_LEFT, EAT_RIGHT)
...
while not WIN:
    if current_player == 'black':
        (black_move_piece) = ask_black()
        (MOVE_RIGHT, MOVE_LEFT, playable_black_piece_location, outside_line, line, eat_line, captured_row, EAT_LEFT, EAT_RIGHT) = find_black_piece()
        ...
        while not possible_move and not possible_eat:
            ...
            (MOVE_RIGHT, MOVE_LEFT, playable_black_piece_location, outside_line, line, eat_line,
             captured_row, EAT_LEFT, EAT_RIGHT) = find_black_piece()
        ...
        (white_move_piece) = ask_white()
        (MOVE_RIGHT, MOVE_LEFT, playable_white_piece_location, outside_line, line, eat_line, captured_row, EAT_LEFT, EAT_RIGHT) = find_white_piece()
        # telling player if they chose a piece that cant be moved
        print('eat left: ', EAT_LEFT, 'eat right: ', EAT_RIGHT)
        print('move right: ', MOVE_RIGHT, 'move left: ', MOVE_LEFT)
        if EAT_LEFT or EAT_RIGHT:
        ...
        while not possible_move and not possible_eat:
            ...
            (white_move_piece) = ask_white()
            (MOVE_RIGHT, MOVE_LEFT, playable_black_piece_location, outside_line, line, eat_line,
             captured_row, EAT_LEFT, EAT_RIGHT) = find_white_piece()
